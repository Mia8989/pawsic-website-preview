...
add_action('wp_head', function () {
    ...
    <style>
      ...
      .page-id-2621 .post-content {
        ...
        width: 100% !important; float: none !important; border: none !important;
      }
      ...
      .page-id-2621 #sidebar, .page-id-2621 .widget-area,
      .page-id-2621 .et_right_sidebar #sidebar, .page-id-2621 .et_left_sidebar #sidebar { display: none !important; }
      ...
      .page-id-2621 #left-area {
        ...
        border: none !important; margin-top: 0 !important; padding-top: 0 !important;
      }
      .page-id-2621 .entry-content, .page-id-2621 .et_pb_post_content {
        overflow: visible !important; padding-top: 0 !important; margin-top: 0 !important;
      }
      .page-id-2621 #et-main-area, .page-id-2621 #main-content,
      .page-id-2621 #main-content .container, .page-id-2621 .et_pb_section,
      .page-id-2621 .et_pb_section:first-child, .page-id-2621 .et_pb_row,
      .page-id-2621 .et_pb_row:first-child, .page-id-2621 .et_pb_column,
      .page-id-2621 .et_pb_column:first-child, .page-id-2621 .et_pb_module,
      .page-id-2621 .et_pb_module:first-child, .page-id-2621 article.page,
      .page-id-2621 article.post, .page-id-2621 .et_pb_extra_column_main,
      .page-id-2621 .et_pb_post, .page-id-2621 .et-l, .page-id-2621 .et-l--post,
      .page-id-2621 .et-l--body, .page-id-2621 .et-l--main, .page-id-2621 #et-boc,
      .page-id-2621 #content-area, .page-id-2621 .et_builder_inner_content,
      .page-id-2621 .et_pb_text_inner, .page-id-2621 .et_pb_section_0,
      .page-id-2621 .et_pb_row_0, .page-id-2621 .et_pb_column_0,
      .page-id-2621 .et_pb_module_0 { padding-top: 0 !important; margin-top: 0 !important; min-height: 0 !important; }
      .page-id-2621 .sfsig-m { margin-top: -50px !important; position: relative; z-index: 1; }
      .page-id-2621 .entry-content > *:not(.sfsig-m) { display: none !important; }
      .sfsig-m, .sfsig-m div, .sfsig-m section, .sfsig-m nav, .sfsig-m ul, .sfsig-m li,
      ...
      .sfsig-m h1, .sfsig-m h2, .sfsig-m h3 { font-family: 'DM Serif Display', Georgia, serif; color: #0c1f3f; line-height: 1.2; font-weight: 400; }
      .sfsig-m h4 { font-family: 'Inter', sans-serif; color: #0c1f3f; font-weight: 700; line-height: 1.3; }
      ...
      .sfsig-m-hero { background: linear-gradient(135deg, #0c1f3f 0%, #1e3a6e 50%, #2b7cca 100%) !important; color: #fff !important; padding: 10rem 0 3.5rem !important; position: relative !important; overflow: hidden !important; }
      .sfsig-m-hero::before { content: ''; position: absolute; top: -30%; right: -15%; width: 600px; height: 600px; background: radial-gradient(circle, rgba(56,182,255,0.1) 0%, transparent 65%); border-radius: 50%; }
      .sfsig-m-hero .wrap { position: relative; z-index: 2; display: flex; align-items: center; gap: 2rem; }
      .sfsig-m-hero .hero-badge { flex-shrink: 0; width: 72px; height: 72px; border-radius: 18px; overflow: hidden; box-shadow: 0 8px 32px rgba(0,0,0,0.3); }
      .sfsig-m-hero .hero-badge img { width: 100%; height: 100%; object-fit: cover; border-radius: 18px; }
      ...
      .sfsig-m-tab { flex-shrink: 0; padding: 1.1rem 1.5rem; font-family: 'Inter', sans-serif; font-size: 0.9rem; font-weight: 500; color: #7a8699 !important; text-decoration: none !important; border-bottom: 3px solid transparent; cursor: pointer; transition: all 0.25s ease; white-space: nowrap; background: none; border-top: none; border-left: none; border-right: none; }
      .sfsig-m-tab:hover { color: #1e3a6e !important; background: #f8fafc; }
      .sfsig-m-tab.active { color: #0c1f3f !important; font-weight: 600; border-bottom-color: #2b7cca; }
      ...
      .sfsig-m .sec-header h2 { font-size: clamp(1.4rem, 2.5vw, 1.85rem) !important; margin-bottom: 0.4rem !important; }
      .sfsig-m .sec-header p { color: #7a8699; font-size: 0.95rem; line-height: 1.6; }
      .sfsig-m .sec-label { display: inline-block; background: #eef5f8; color: #1e3a6e; font-family: 'Inter', sans-serif; font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; padding: 0.3rem 0.9rem; border-radius: 100px; margin-bottom: 0.75rem; }
      .sfsig-m .access-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; }
      .sfsig-m .access-card { background: #fff !important; border-radius: 20px; padding: 2.25rem 2rem !important; border: 1px solid #e8edf2; transition: all 0.35s ease; position: relative; overflow: hidden; }
      .sfsig-m .access-card:hover { transform: translateY(-4px); box-shadow: 0 16px 48px rgba(12,31,63,0.1); border-color: rgba(43,124,202,0.25); }
      .sfsig-m .access-card .card-num { position: absolute; top: 1.5rem; right: 1.75rem; font-size: 3rem; font-weight: 800; color: rgba(43,124,202,0.06); line-height: 1; font-family: 'Inter', sans-serif; }
      .sfsig-m .access-card .card-icon { width: 44px; height: 44px; border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.25rem; background: linear-gradient(135deg, #1e3a6e, #2b7cca); color: #fff; }
      .sfsig-m .access-card h3 { font-size: 1.15rem !important; font-family: 'Inter', sans-serif !important; font-weight: 700 !important; color: #0c1f3f !important; margin-bottom: 0.4rem !important; }
      .sfsig-m .access-card p { color: #7a8699; font-size: 0.88rem; line-height: 1.6; margin-bottom: 1.25rem; }
      .sfsig-m .access-card .card-link { display: inline-flex; align-items: center; gap: 0.4rem; font-weight: 600; font-size: 0.85rem; color: #2b7cca !important; text-decoration: none !important; }
      ...
      .sfsig-m .webinar-item { display: flex; align-items: center; gap: 1.25rem; background: #fff; border-radius: 16px; padding: 0; border: 1px solid #e8edf2; transition: all 0.3s ease; text-decoration: none !important; color: inherit !important; overflow: hidden; }
      .sfsig-m .webinar-item:hover { border-color: rgba(43,124,202,0.3); box-shadow: 0 4px 20px rgba(12,31,63,0.06); transform: translateY(-2px); }
      .sfsig-m .webinar-item .w-thumb { width: 200px; height: 112px; flex-shrink: 0; overflow: hidden; position: relative; }
      .sfsig-m .webinar-item .w-thumb img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease; }
      .sfsig-m .webinar-item:hover .w-thumb img { transform: scale(1.05); }
      .sfsig-m .webinar-item .w-play { position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); width: 36px; height: 36px; border-radius: 50%; background: rgba(12,31,63,0.7); color: #fff; display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s; }
      .sfsig-m .webinar-item:hover .w-play { opacity: 1; }
      .sfsig-m .webinar-item .w-info { flex: 1; min-width: 0; padding: 1rem 0; }
      .sfsig-m .webinar-item .w-info h3 { font-size: 0.95rem !important; font-family: 'Inter', sans-serif !important; font-weight: 600 !important; color: #0c1f3f !important; margin-bottom: 0.15rem !important; }
      ...
      .sfsig-m .w-badge { font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; padding: 0.25rem 0.65rem; border-radius: 100px; white-space: nowrap; }
      ...
      .sfsig-m .res-layout { display: grid; grid-template-columns: 240px 1fr; gap: 2.5rem; align-items: start; }
      .sfsig-m .res-sidebar { position: sticky; top: 5rem; }
      .sfsig-m .res-sidebar-title { font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; color: #7a8699; margin-bottom: 1rem; font-family: 'Inter', sans-serif; }
      .sfsig-m .res-nav { list-style: none; display: flex; flex-direction: column; gap: 0.25rem; padding: 0 !important; margin: 0 !important; }
      .sfsig-m .res-nav li { list-style: none !important; }
      .sfsig-m .res-nav li a { display: flex; align-items: center; justify-content: space-between; padding: 0.65rem 1rem; border-radius: 10px; font-size: 0.88rem; font-weight: 500; color: #3d4a5c !important; text-decoration: none !important; transition: all 0.2s ease; }
      ...
      .sfsig-m .res-nav li a .nav-count { font-size: 0.72rem; font-weight: 600; color: #7a8699; background: #f0f3f6; padding: 0.15rem 0.55rem; border-radius: 100px; }
      .sfsig-m .res-nav li a.active .nav-count { color: rgba(255,255,255,0.6); background: rgba(255,255,255,0.15); }
      .sfsig-m .res-cards { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; }
      .sfsig-m .res-card { background: #fff; border-radius: 16px; padding: 1.75rem; border: 1px solid #e8edf2; transition: all 0.3s ease; text-decoration: none !important; display: flex; flex-direction: column; }
      .sfsig-m .res-card:hover { box-shadow: 0 8px 28px rgba(12,31,63,0.08); border-color: rgba(43,124,202,0.25); }
      .sfsig-m .res-card .res-type { font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; color: #3a9e8f; margin-bottom: 0.5rem; display: inline-block; background: rgba(58,158,143,0.08); padding: 0.2rem 0.6rem; border-radius: 100px; }
      .sfsig-m .res-card .res-type-blue { color: #2b7cca; background: rgba(43,124,202,0.08); }
      .sfsig-m .res-card .res-type-gold { color: #b8942e; background: rgba(184,148,46,0.08); }
      .sfsig-m .res-card .res-type-purple { color: #7c5cbf; background: rgba(124,92,191,0.08); }
      .sfsig-m .res-card .res-type-green { color: #2e8b57; background: rgba(46,139,87,0.08); }
      .sfsig-m .res-card h3 { font-size: 1rem !important; font-family: 'Inter', sans-serif !important; font-weight: 600 !important; color: #0c1f3f !important; margin-bottom: 0.35rem !important; }
      .sfsig-m .res-card p { color: #7a8699; font-size: 0.85rem; line-height: 1.6; margin-bottom: 0.75rem; }
      .sfsig-m .res-card .res-link { display: inline-flex; align-items: center; gap: 0.35rem; font-weight: 600; font-size: 0.82rem; color: #2b7cca !important; margin-top: auto; }
      .sfsig-m .res-card .res-link svg { transition: transform 0.3s; }
      .sfsig-m .res-card:hover .res-link svg { transform: translateX(3px); }
      .sfsig-m .lib-link { display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 1.5rem; font-weight: 600; font-size: 0.9rem; color: #2b7cca !important; text-decoration: none !important; }
      .sfsig-m .lib-link:hover { color: #1e3a6e !important; }
      .sfsig-m .forum-box { background: #fff; border-radius: 20px; border: 1px solid #e8edf2; overflow: hidden; box-shadow: 0 4px 20px rgba(12,31,63,0.06); }
      .sfsig-m .forum-bar { display: flex; align-items: center; justify-content: space-between; padding: 1.25rem 1.75rem; border-bottom: 1px solid #e8edf2; flex-wrap: wrap; gap: 0.75rem; }
      .sfsig-m .forum-bar h3 { font-size: 1rem !important; font-family: 'Inter', sans-serif !important; font-weight: 600 !important; color: #0c1f3f !important; margin-bottom: 0 !important; }
      .sfsig-m .forum-bar p { color: #7a8699; font-size: 0.85rem; margin-bottom: 0; }
      .sfsig-m .forum-open-btn { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.6rem 1.25rem; border-radius: 100px; font-weight: 600; font-size: 0.85rem; background: rgba(43,124,202,0.08) !important; color: #2b7cca !important; border: 1.5px solid rgba(43,124,202,0.2); text-decoration: none !important; transition: all 0.3s ease; }
      .sfsig-m .forum-open-btn:hover { background: rgba(43,124,202,0.15) !important; border-color: #2b7cca; transform: translateY(-1px); }
      .sfsig-m .forum-open-btn svg { flex-shrink: 0; }
      .sfsig-m .forum-preview-note { background: #eef5f8; padding: 0.75rem 1.75rem; font-size: 0.82rem; color: #1e3a6e; display: flex; align-items: center; gap: 0.5rem; border-bottom: 1px solid #e8edf2; }
      .sfsig-m .forum-preview-note svg { flex-shrink: 0; color: #2b7cca; }
      .sfsig-m .forum-frame { width: 100%; min-height: 600px; border: none; display: block; }
      .sfsig-m .about-split { display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start; margin-bottom: 3rem; }
      .sfsig-m .about-split:last-child { margin-bottom: 0; }
      .sfsig-m .about-content h2 { margin-bottom: 1rem !important; }
      .sfsig-m .about-content p { color: #3d4a5c; font-size: 0.95rem; line-height: 1.75; margin-bottom: 1rem; }
      .sfsig-m .about-highlight { background: linear-gradient(135deg, #0c1f3f 0%, #1e3a6e 100%); border-radius: 20px; padding: 2.5rem; color: #fff; position: relative; overflow: hidden; }
      .sfsig-m .about-highlight::before { content: ''; position: absolute; top: -30%; right: -20%; width: 250px; height: 250px; background: radial-gradient(circle, rgba(56,182,255,0.15) 0%, transparent 70%); border-radius: 50%; }
      .sfsig-m .about-highlight h3 { color: #fff !important; font-size: 1.2rem !important; margin-bottom: 1rem !important; position: relative; z-index: 1; }
      .sfsig-m .about-highlight p { color: rgba(255,255,255,0.7) !important; font-size: 0.9rem; line-height: 1.7; position: relative; z-index: 1; }
      .sfsig-m .about-highlight .highlight-stat { display: flex; gap: 2rem; margin-top: 1.5rem; position: relative; z-index: 1; }
      .sfsig-m .about-highlight .stat-item { text-align: center; }
      .sfsig-m .about-highlight .stat-num { font-family: 'DM Serif Display', serif; font-size: 2rem; color: #38b6ff; display: block; line-height: 1.1; }
      .sfsig-m .about-highlight .stat-label { font-size: 0.75rem; color: rgba(255,255,255,0.5); text-transform: uppercase; letter-spacing: 1px; }
      .sfsig-m .values-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; }
      .sfsig-m .value-card { background: #fff; border-radius: 16px; padding: 2rem; border: 1px solid #e8edf2; text-align: center; transition: all 0.3s ease; }
      .sfsig-m .value-card:hover { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(12,31,63,0.08); border-color: rgba(43,124,202,0.2); }
      .sfsig-m .value-card .val-icon { width: 52px; height: 52px; border-radius: 14px; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem; background: linear-gradient(135deg, #eef5f8, #dceef8); color: #1e3a6e; }
      .sfsig-m .value-card h4 { font-size: 1rem; margin-bottom: 0.4rem; }
      .sfsig-m .value-card p { color: #7a8699; font-size: 0.85rem; line-height: 1.6; }
      .sfsig-m .chairs-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; }
      .sfsig-m .chair-card { background: #fff; border-radius: 20px; padding: 2rem; border: 1px solid #e8edf2; display: flex; gap: 1.5rem; align-items: flex-start; transition: all 0.3s ease; }
      .sfsig-m .chair-card:hover { box-shadow: 0 8px 28px rgba(12,31,63,0.08); border-color: rgba(43,124,202,0.2); }
      .sfsig-m .chair-avatar { width: 72px; height: 72px; border-radius: 50%; flex-shrink: 0; object-fit: cover; object-position: center top; border: 2px solid #EBF4FF; background: #f0f4f8; }
      .sfsig-m .chair-info h4 { font-size: 1.05rem; margin-bottom: 0.15rem; }
      .sfsig-m .chair-info .chair-creds { font-size: 0.8rem; font-weight: 600; color: #2b7cca; margin-bottom: 0.25rem; display: block; }
      .sfsig-m .chair-info .chair-role { display: inline-block; background: #EBF4FF; color: #1B5E9E; font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; padding: 0.2rem 0.65rem; border-radius: 1rem; margin-bottom: 0.5rem; }
      .sfsig-m .chair-info .chair-role-liaison { background: #dce8f7; color: #1A5494; }
      .sfsig-m .chair-info p { font-size: 0.85rem; color: #7a8699; line-height: 1.6; }
      .sfsig-m .btn { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.7rem 1.5rem; border-radius: 100px; font-weight: 600; font-size: 0.85rem; border: none; cursor: pointer; transition: all 0.3s ease; text-decoration: none !important; }
      .sfsig-m .btn-primary { background: #38b6ff !important; color: #fff !important; box-shadow: 0 4px 16px rgba(56,182,255,0.2); }
      .sfsig-m .btn-primary:hover { background: #2da5ee !important; color: #fff !important; transform: translateY(-2px); box-shadow: 0 8px 28px rgba(56,182,255,0.3); }
      .sfsig-m .btn-outline { background: transparent !important; color: #1e3a6e !important; border: 1.5px solid #dce3eb !important; }
      .sfsig-m .btn-outline:hover { background: #eef5f8 !important; border-color: #1e3a6e !important; }
      .sfsig-m .btn-outline-light { background: rgba(255,255,255,0.1) !important; color: #fff !important; border: 1.5px solid rgba(255,255,255,0.3) !important; }
      .sfsig-m .btn-outline-light:hover { background: rgba(255,255,255,0.2) !important; color: #fff !important; border-color: rgba(255,255,255,0.5) !important; }
      .sfsig-m .cta-banner { background: linear-gradient(135deg, #0c1f3f 0%, #1e3a6e 100%); border-radius: 24px; padding: 2.5rem 3rem; display: flex; align-items: center; justify-content: space-between; gap: 2rem; flex-wrap: wrap; position: relative; overflow: hidden; }
      .sfsig-m .cta-banner::before { content: ''; position: absolute; top: -40%; right: -15%; width: 350px; height: 350px; background: radial-gradient(circle, rgba(56,182,255,0.12) 0%, transparent 70%); border-radius: 50%; }
      .sfsig-m .cta-banner h2 { color: #fff !important; font-size: 1.35rem !important; margin-bottom: 0.25rem !important; position: relative; z-index: 1; }
      .sfsig-m .cta-banner p { color: rgba(255,255,255,0.6); font-size: 0.9rem; position: relative; z-index: 1; }
    ...
    <div class="wrap">
      ...
      <div class="access-grid">
        <div class="access-card">
          ...
          <div class="card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></div>
        ...
        <div class="access-card">
          ...
          <div class="card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div>
        ...
        <div class="access-card">
          ...
          <div class="card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></div>
    ...
    <div class="wrap">
      ...
      <div class="webinar-list">
        <a href="https://memberships.pawsic.org/leading-the-conversation-on-skin-failure-overview-of-best-practices/" class="webinar-item">
          <div class="w-thumb"><img src="https://pawsic.org/images/webinars/Leading-the-Conversation-on-Skin-Failure-Overview-of-Best-Practices-300x167.webp" alt="Leading the Conversation on Skin Failure: Overview of Best Practices"><div class="w-play"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg></div></div>
          <div class="w-info"><h3>Leading the Conversation on Skin Failure: Overview of Best Practices</h3><p>November 2025: Evidence-based approaches to skin failure recognition and documentation</p></div>
        ...
        <a href="https://memberships.pawsic.org/leading-the-conversation-on-skin-failure" class="webinar-item">
          <div class="w-thumb"><img src="https://pawsic.org/images/webinars/Leading-the-Conversation-on-Skin-Failure-The-SF-SIG-of-PAWSIC-Inaugural-Call-to-Action-300x167.webp" alt="Leading the Conversation on Skin Failure"><div class="w-play"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg></div></div>
          <div class="w-info"><h3>Leading the Conversation on Skin Failure</h3><p>September 2025: Advancing clinical recognition and differentiating from pressure injuries</p></div>
          <div class="w-badges"><span class="w-badge w-badge-green">On-Demand</span><span class="w-badge w-badge-blue">CE</span></div>
        </a>
        <a href="https://memberships.pawsic.org/end-of-life-skin-wound-changes-webinar-part-2/" class="webinar-item">
          <div class="w-thumb"><img src="https://pawsic.org/images/webinars/End-of-Life-Skin-and-Wound-Changes-Webinar-Part-2.jpg" alt="End-of-Life Skin and Wound Changes Webinar Part 2"><div class="w-play"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg></div></div>
          <div class="w-info"><h3>End-of-Life Skin &amp; Wound Changes Webinar Part 2</h3><p>July 2024: Clinical guidance for managing skin changes at end of life</p></div>
          <div class="w-badges"><span class="w-badge w-badge-green">On-Demand</span><span class="w-badge w-badge-blue">CE</span></div>
        </a>
        <a href="https://memberships.pawsic.org/webinar-attendees-only/" class="webinar-item">
          <div class="w-thumb"><img src="https://pawsic.org/images/webinars/End-of-Life-Skin-Wound-Changes-2024-1024x576.png" alt="PAWSIC Webinar on End-of-Life Skin and Wound Changes"><div class="w-play"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg></div></div>
          <div class="w-info"><h3>PAWSIC Webinar on End-of-Life Skin &amp; Wound Changes: SCALE, KTUs and Skin Failure</h3><p>2024: Foundations of end-of-life skin and wound assessment</p></div>
          <div class="w-badges"><span class="w-badge w-badge-green">On-Demand</span><span class="w-badge w-badge-blue">CE</span></div>
        </a>
      </div>
    ...
    <div class="wrap">
      ...
      <div class="res-layout">
        <nav class="res-sidebar">
          ...
          <ul class="res-nav">
            <li><a href="#" class="active" data-filter="all"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>All Resources</span><span class="nav-count">20</span></a></li>
            <li><a href="#" data-filter="skin-failure"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>Skin Failure</span><span class="nav-count">13</span></a></li>
            <li><a href="#" data-filter="clinical-guide"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>Clinical Guides</span><span class="nav-count">2</span></a></li>
            <li><a href="#" data-filter="position-statement"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>Position Statements</span><span class="nav-count">1</span></a></li>
            <li><a href="#" data-filter="reference"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>References</span><span class="nav-count">3</span></a></li>
            <li><a href="#" data-filter="commentary"><span><svg style="display:inline;vertical-align:-3px;width:16px;height:16px;margin-right:6px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>Commentary</span><span class="nav-count">1</span></a></li>
          </ul>
        ...
        <div class="res-cards">
          ...
          <a href="https://memberships.pawsic.org/wp-content/uploads/2026/05/Annotated-Bib_Skin-Failure-5_2026-compressed.pdf" class="res-card" data-category="reference" target="_blank">
            <span class="res-type res-type-purple">Annotated Bibliography</span>
            <h3>Skin Failure Annotated Bibliography 5/2026</h3>
            <p>Annotated bibliography of current skin failure literature, compiled to support clinical practice, research, and documentation standards. May 2026.</p>
          ...
          <a href="https://memberships.pawsic.org/wp-content/uploads/2026/05/Annotated-Bib_Skin-Failure-5_2026-compressed.pdf" class="res-card" data-category="skin-failure" target="_blank">
            <span class="res-type res-type-purple">Annotated Bibliography</span>
            <h3>Skin Failure Annotated Bibliography, May 2026</h3>
            <p>Annotated bibliography of current skin failure literature, compiled to support clinical practice, research, and documentation standards. May 2026.</p>
            <span class="res-link">Download PDF <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M7 17L17 7M17 7H7M17 7v10"/></svg></span>
          </a>
...
<div class="sfsig-m-panel" id="panel-community" role="tabpanel">
  <section class="sec sec-light">
    <div class="wrap">
      ...
      <div class="forum-box">
        <div class="forum-bar">
          <div><h3>Skin Failure Shared Interest Group</h3><p>Peer discussions, case consultations, and clinical updates</p></div>
          <a href="https://memberships.pawsic.org/mp-circle/skin-failure-shared-interest-group/" class="forum-open-btn" target="_blank"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>Open in New Tab</a>
        </div>
...
<div class="sfsig-m-panel" id="panel-about" role="tabpanel">
      ...
      <div class="about-split">
        ...
        <div class="about-highlight">
          ...
          <div class="highlight-stat">
            <div class="stat-item"><span class="stat-num">4+</span><span class="stat-label">Webinars</span></div>
            <div class="stat-item"><span class="stat-num">5</span><span class="stat-label">Publications</span></div>
            <div class="stat-item"><span class="stat-num">1</span><span class="stat-label">Code Proposal</span></div>
          </div>
        </div>
      </div>
      <div class="about-split">
  ...
  <section class="sec sec-light">
    <div class="wrap">
      <div class="sec-header"><span class="sec-label">Our Values</span><h2>What <em>Guides</em> Us</h2></div>
      <div class="values-grid">
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><h4>Evidence-Based Practice</h4><p>Every recommendation, resource, and position statement is grounded in peer-reviewed research and clinical evidence.</p></div>
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><h4>Interprofessional Collaboration</h4><p>We believe the best outcomes come from bringing together diverse perspectives across disciplines, roles, and care settings.</p></div>
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><h4>Patient-Centered Care</h4><p>At the heart of our work is the patient. Accurate skin failure recognition leads to better care, better documentation, and better outcomes.</p></div>
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><h4>Clinical Advocacy</h4><p>We advocate for proper recognition of skin failure through code proposals, position statements, and education that empowers clinicians.</p></div>
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div><h4>Education &amp; Knowledge Sharing</h4><p>Through webinars, clinical resources, and peer forums, we make the latest skin failure research accessible to the entire care team.</p></div>
        <div class="value-card"><div class="val-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></div><h4>Inclusive Community</h4><p>The SF SIG welcomes clinicians, researchers, students, industry partners, caregivers, patients, and families who share a commitment to advancing skin failure care.</p></div>
      </div>
    </div>
  </section>
  ...
  <section class="sec sec-frost">
    <div class="wrap">
      <div class="sec-header"><span class="sec-label">Leadership</span><h2>SF SIG <em>Chairs</em></h2><p>The Skin Failure SIG is led by nationally recognized wound care clinicians, researchers, and legal nurse consultants with decades of specialized expertise.</p></div>
      <div class="chairs-grid">
        <div class="chair-card"><img src="https://pawsic.org/images/sig-chairs/heidi-cross.jpg" alt="Heidi H. Cross" class="chair-avatar" loading="lazy"><div class="chair-info"><h4>Heidi H. Cross</h4><span class="chair-creds">MSN, RN, FNP-BC, CWON, CDP</span><span class="chair-role">Co-Chair</span><p>Board-certified Wound and Ostomy nurse and Family Nurse Practitioner consulting for long-term care facilities and at Strong Memorial Hospital in Rochester. A legal nurse consultant and published author in the Journal of Wound Ostomy and Continence Nursing, the American Journal of Nursing, and the American Nurse Journal.</p></div></div>
        <div class="chair-card"><img src="https://pawsic.org/images/sig-chairs/cynthia-sylvia.jpeg" alt="Cynthia Sylvia" class="chair-avatar" loading="lazy"><div class="chair-info"><h4>Cynthia Sylvia</h4><span class="chair-creds">D NURS, MSc, MA, RN, CWCN</span><span class="chair-role">Co-Chair</span><p>Legal nurse consultant with over four decades of expertise as a board-certified Wound Ostomy Continence Nurse. Holds a Doctorate in Nursing and a Master of Science in Wound Healing and Tissue Repair from Cardiff University, where she is an Honorary Lecturer. Her contributions span global consensus development on SCALE, academic publishing, and interprofessional education.</p></div></div>
        <div class="chair-card"><img src="https://pawsic.org/images/sig-chairs/pamela-scarborough.jpg" alt="Pamela Scarborough" class="chair-avatar" loading="lazy"><div class="chair-info"><h4>Pamela Scarborough</h4><span class="chair-creds">PT, DPT, CWS, FAAWC</span><span class="chair-role">Co-Chair</span><p>Physical therapist specializing in wound management with her Certified Wound Specialist (CWS) designation for over 24 years. Her career spans Orthopedics, Sports Medicine, Cardiac Rehabilitation, Geriatric physical therapy, and Wound Management. She has supported healthcare professionals across disciplines in acquiring their Board Certifications as wound specialists.</p></div></div>
        <div class="chair-card"><img src="https://pawsic.org/images/sig-chairs/diane-krasner.jpeg" alt="Diane L. Krasner" class="chair-avatar" loading="lazy"><div class="chair-info"><h4>Diane L. Krasner</h4><span class="chair-creds">PhD, RN, FAAN, FAAWC, MAPWCA</span><span class="chair-role chair-role-liaison">Board Liaison</span><p>Board-certified wound care nurse with over thirty-five years of experience. Interim Past President of PAWSIC, Fellow of the American Academy of Nursing, Fellow of the Association for the Advancement of Wound Care, and Master of the American Professional Wound Care Association. Widely published wound and skin care consultant, educator, and expert witness.</p></div></div>
      </div>
...
<section class="sec sec-cream">
  <div class="wrap">
    <div class="cta-banner">
      <div><h2>Questions About Your Membership?</h2><p>Manage your account, explore CE courses, or visit the main PAWSIC portal.</p></div>
      <div style="display:flex;gap:0.75rem;flex-wrap:wrap"><a href="https://memberships.pawsic.org/account/" class="btn btn-primary">My Account</a><a href="https://memberships.pawsic.org/courses/person-centered-wound-care-post-acute/" class="btn btn-outline-light">CE Courses</a></div>
    </div>
  </div>
</section>
